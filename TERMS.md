...
Arcana Wallet
Arcana Wallet is a decentralised non-custodial blockchain identity wallet for users to store, and engage in transactions relating to digital assets. It is visualised on a secure Ethereum provider interface for blockchain file access transaction sign/approval by dApp, allowing social OAuth and passwordless authentication for dApps, file data encryption/decryption, distributed key generation for dApps.
...
Arcana Auth
Arcana Auth aims to provide developers with a decentralized, non-custodial public key infrastructure(PKI), allowing dApp users to claim a public-private key pair. This enables social OAuth and passwordless authentication for dApps and distributed key generation for signing blockchain transactions. Developers can choose from a variety of OAuth-based user signup options like Gmail, Facebook, Twitter and even custom OAuth-based signup schemes.

Non-custodial nature of smart contracts
...
No Insurance
Digital assets are not legal tender, are not backed by the government, and are not subject to the Deposit Insurance Scheme or protections under any banking or securities laws. Garoutech is not a bank and does not offer fiduciary services, nor does it offer any security broking services.
...
Additional conditions of usage of the Website and Services
...
Abusive Activity: you agree not to engage in any activity that poses a threat to Arcana or the Website, for example by distributing a virus or other harmful code, or through unauthorized access to the Website or other users’ digital assets.
...
Fraud: you agree not to engage in any activity which operates to defraud Garoutech, other users, or any other person; or to provide any false, inaccurate, or misleading information to Garoutech. 
...
Links to Other Web Websites and Content
